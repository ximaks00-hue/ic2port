...
public class CompressorBlockEntity extends BaseMachineBlockEntity {
    ...
    public CompressorBlockEntity(final BlockPos pos, final BlockState state) {
        super(BlockEntityRegistry.COMPRESSOR_BE.get(), pos, state, SLOT_COUNT, ENERGY_CAPACITY);
    }
    ...
    public static void serverTick(
            ...
            final CompressorBlockEntity compressor) {
        compressor.tickServer();
    }
    ...
    private void tickServer() {
        ...
        Optional<CompressorRecipe> recipeOptional = resolveActiveRecipe(input);
        ...
        CompressorRecipe recipe = recipeOptional.get();
    ...
    private boolean canOutput(final CompressorRecipe recipe, final ItemStack output) {
    ...
    public Component getDisplayName() {
        return Component.translatable("block.ic2port.compressor");
    }
