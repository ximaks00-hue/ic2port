...
public class ElectricFurnaceBlockEntity extends BaseMachineBlockEntity {
    ...
    public static final double ENERGY_PER_TICK = 3.0D;
    public static final int DEFAULT_PROCESSING_TIME = 130;
    ...
    public ElectricFurnaceBlockEntity(final BlockPos pos, final BlockState state) {
        super(BlockEntityRegistry.ELECTRIC_FURNACE_BE.get(), pos, state, SLOT_COUNT, ENERGY_CAPACITY);
    }
    ...
    public static void serverTick(
            ...
            final ElectricFurnaceBlockEntity furnace) {
        furnace.tickServer();
    }
    ...
    private void tickServer() {
        ...
        Optional<ElectricFurnaceRecipe> recipeOptional = resolveActiveRecipe(input);
    ...
    public Component getDisplayName() {
        return Component.translatable("block.ic2port.electric_furnace");
    }
