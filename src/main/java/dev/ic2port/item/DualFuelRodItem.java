...
/**
 * Two uranium cells in one slot — counts as 2 fuel rods for neighbour pulse purposes.
 */
public class DualFuelRodItem extends RadioactiveItem implements IReactorFuel {

    public static final int RODS = 2;
    public static final int MAX_DEPLETION = FuelRodItem.MAX_DEPLETION;

    public DualFuelRodItem(final Properties properties) {
