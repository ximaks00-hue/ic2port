...
/**
 * Enriched uranium fuel rod — generates EU and heat inside a nuclear reactor.
 */
public class FuelRodItem extends RadioactiveItem implements IReactorFuel {

    public static final String DEPLETION_TAG = "Depletion";
    public static final int MAX_DEPLETION = 20_000;

    public FuelRodItem(final Properties properties) {
    ...
    public static boolean isDepletedStack(final ItemStack stack) {
        return stack.getItem() instanceof FuelRodItem rod && rod.isDepleted(stack);
    }
