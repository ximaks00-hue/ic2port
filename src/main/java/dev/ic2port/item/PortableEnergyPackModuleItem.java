...
/**
 * LV portable EU storage installable in nano / quantum chestplate module slots.
 */
public class PortableEnergyPackModuleItem extends ArmorModuleItem implements IModulePortableEnergyPack {
    ...
    public PortableEnergyPackModuleItem(final Properties properties) {
        super(properties);
    }
    ...
    public void appendHoverText(
        ...
        tooltip.add(Component.translatable("item.ic2port.portable_energy_pack_module.energy", stored, (int) CAPACITY)
                .withStyle(ChatFormatting.GRAY));
        tooltip.add(Component.translatable("item.ic2port.portable_energy_pack_module.hint")
