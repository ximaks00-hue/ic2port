...
public class IsuScreen extends AbstractContainerScreen<IsuMenu> {

    private static final ResourceLocation TEXTURE =
            new ResourceLocation("minecraft", "textures/gui/container/furnace.png");

    public IsuScreen(final IsuMenu menu, final Inventory playerInventory, final Component title) {
