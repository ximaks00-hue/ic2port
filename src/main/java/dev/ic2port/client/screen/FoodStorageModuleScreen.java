...
public class FoodStorageModuleScreen extends AbstractContainerScreen<FoodStorageModuleMenu> {

    private static final ResourceLocation CONTAINER_TEXTURE =
            new ResourceLocation("minecraft", "textures/gui/container/generic_54.png");

    public FoodStorageModuleScreen(
            final FoodStorageModuleMenu menu,
