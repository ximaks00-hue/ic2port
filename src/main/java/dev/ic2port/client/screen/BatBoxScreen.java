...
public class BatBoxScreen extends AbstractContainerScreen<BatBoxMenu> {
    ...
    public BatBoxScreen(final BatBoxMenu menu, final Inventory playerInventory, final Component title) {
    ...
    protected void renderBg(final GuiGraphics guiGraphics, final float partialTick, final int mouseX, final int mouseY) {
        ...
        if (energyHeight > 0) {
            guiGraphics.blit(FURNACE_TEXTURE, x + 116, y + 17 + (52 - energyHeight), 176, 52 - energyHeight, 16, energyHeight);
        }
    }
