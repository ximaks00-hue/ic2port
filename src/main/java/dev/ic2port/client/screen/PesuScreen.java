...
public class PesuScreen extends AbstractContainerScreen<PesuMenu> {

    private static final ResourceLocation TEXTURE =
            new ResourceLocation("minecraft", "textures/gui/container/furnace.png");

    public PesuScreen(final PesuMenu menu, final Inventory playerInventory, final Component title) {
