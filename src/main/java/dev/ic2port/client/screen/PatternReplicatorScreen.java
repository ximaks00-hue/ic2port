...
public class PatternReplicatorScreen extends MachineScreen<PatternReplicatorMenu> {

    public PatternReplicatorScreen(final PatternReplicatorMenu menu, final Inventory playerInventory,
