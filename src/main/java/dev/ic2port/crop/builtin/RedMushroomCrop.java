...
public class RedMushroomCrop extends BaseCrop {

    public RedMushroomCrop() {
        super(
                new ResourceLocation(Reference.MOD_ID, "red_mushroom"),
                Component.translatable("crop.ic2port.red_mushroom"),
                new CropProperties(2, 0, 1, 0, 1, 0),
                new String[]{"red", "mushroom", "food"},
                4);
    }
    ...
    public ItemStack[] getDrops(final ICropTile tile) {
        return new ItemStack[]{new ItemStack(Items.RED_MUSHROOM, 1 + tile.getGainStat() / 8)};
    }
}
