    ...
    public static final RegistryObject<CreativeModeTab> IC2_TAB = CREATIVE_TABS.register("main",
            () -> CreativeModeTab.builder()
                    ...
                    .displayItems((parameters, output) -> {
                        ...
                        output.accept(ItemRegistry.ITEM_TUBE.get());
                        output.accept(ItemRegistry.EXTRACTION_TUBE.get());
                        output.accept(ItemRegistry.REQUEST_TUBE.get());
                        output.accept(ItemRegistry.LIMITER_TUBE.get());
                        output.accept(ItemRegistry.SORTING_TUBE.get());
                        output.accept(ItemRegistry.FILTER_TUBE.get());
                        output.accept(ItemRegistry.SPEED_TUBE.get());
                        output.accept(ItemRegistry.COLOR_FILTER_TUBE.get());
                        output.accept(ItemRegistry.HOVER_TUBE.get());
                        output.accept(ItemRegistry.FILTERED_EXTRACTION_TUBE.get());
                        output.accept(ItemRegistry.PICKUP_TUBE.get());
                        output.accept(ItemRegistry.REDSTONE_TUBE.get());
                        output.accept(ItemRegistry.SWITCH_TUBE.get());
                        output.accept(ItemRegistry.TRANSPORT_TUBE.get());
                        output.accept(ItemRegistry.ROUND_ROBIN_TUBE.get());
                        output.accept(ItemRegistry.STACKING_TUBE.get());
                        output.accept(ItemRegistry.TELEPORT_TUBE.get());
                        output.accept(ItemRegistry.PROVIDER_TUBE.get());
                        output.accept(ItemRegistry.INSERTION_TUBE.get());
                        output.accept(ItemRegistry.STICKY_TUBE.get());
                        output.accept(ItemRegistry.MACHINE_BUFFER.get());
                        output.accept(ItemRegistry.VILLAGER_O_MAT.get());
                        output.accept(ItemRegistry.TUBE_CONFIGURATOR.get());
                        output.accept(ItemRegistry.TEA_LEAF.get());
                        output.accept(ItemRegistry.COFFEE_BEAN.get());
                        ...
                        output.accept(ItemRegistry.MINING_PIPE.get());
                        ...
                        output.accept(ItemRegistry.IMPORT_UPGRADE.get());
                        output.accept(ItemRegistry.EXPORT_UPGRADE.get());
                        ...
                        output.accept(ItemRegistry.NANO_SABER.get());
                        ...
                        output.accept(ItemRegistry.STEAM_REACTOR.get());
                        output.accept(ItemRegistry.STEAM_CHAMBER.get());
                        output.accept(ItemRegistry.STEAM_VENT.get());
                        output.accept(ItemRegistry.ADVANCED_STEAM_VENT.get());
                        output.accept(ItemRegistry.FLUID_PIPE.get());
                        output.accept(ItemRegistry.FLUID_PUMP.get());
                        output.accept(ItemRegistry.VOID_PIPE.get());
