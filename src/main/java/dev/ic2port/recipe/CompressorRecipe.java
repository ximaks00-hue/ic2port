...
public class CompressorRecipe implements Recipe<Container>, IMachineRecipe {
    ...
    public RecipeSerializer<?> getSerializer() {
        return RecipeSerializerRegistry.COMPRESSOR_SERIALIZER.get();
    }

    @Override
    public RecipeType<?> getType() {
        return RecipeTypeRegistry.COMPRESSOR.get();
    }
