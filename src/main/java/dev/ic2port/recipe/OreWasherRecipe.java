...
/**
 * Recipe for the Ore Washer: crushed ore input → purified ore output + stone dust.
 */
public class OreWasherRecipe implements Recipe<Container>, IMachineRecipe {
    ...
    public OreWasherRecipe(final ResourceLocation id, final Ingredient input,
    ...
    public RecipeSerializer<?> getSerializer() {
        return RecipeSerializerRegistry.ORE_WASHER_SERIALIZER.get();
    }

    @Override public RecipeType<?> getType() { return RecipeTypeRegistry.ORE_WASHER.get(); }
