...
public class ElectricFurnaceRecipe implements Recipe<Container>, IMachineRecipe {
    ...
    public RecipeSerializer<?> getSerializer() {
        return RecipeSerializerRegistry.ELECTRIC_FURNACE_SERIALIZER.get();
    }

    @Override
    public RecipeType<?> getType() {
        return RecipeTypeRegistry.ELECTRIC_FURNACE.get();
    }
