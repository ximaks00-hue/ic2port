...
public class MetalFormerRecipe implements Recipe<Container>, IMachineRecipe {
    ...
    public RecipeSerializer<?> getSerializer() {
        return RecipeSerializerRegistry.METAL_FORMER_SERIALIZER.get();
    }

    @Override
    public RecipeType<?> getType() {
        return RecipeTypeRegistry.METAL_FORMER.get();
    }
