...
public class MetalFormerMenu extends MachineWithUpgradesMenu {
    ...
    public MetalFormerMenu(
            ...
            final MetalFormerBlockEntity blockEntity,
            final ContainerData data) {
        super(MenuTypeRegistry.METAL_FORMER_MENU.get(), containerId);
        ...
        this.addSlot(new SlotItemHandler(itemHandler, MetalFormerBlockEntity.SLOT_OUTPUT, MachineMenuLayout.SLOT_OUTPUT_X, MachineMenuLayout.SLOT_OUTPUT_Y) {
            @Override
    ...
    private static MetalFormerBlockEntity getBlockEntity(
            final Inventory playerInventory,
        ...
        if (blockEntity instanceof MetalFormerBlockEntity former) {
            return former;
        }
        throw new IllegalStateException("Expected MetalFormerBlockEntity at provided BlockPos");
    }
}
