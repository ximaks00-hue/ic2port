...
public class CannerMenu extends MachineWithUpgradesMenu {

    private final AbstractCannerBlockEntity blockEntity;
    private final Level level;
    private final ContainerData data;

    public CannerMenu(final int containerId, final Inventory playerInventory, final FriendlyByteBuf extraData) {
    ...
    public CannerMenu(
        ...
        super(MenuTypeRegistry.CANNER_MENU.get(), containerId);
    ...
    private static AbstractCannerBlockEntity getBlockEntity(
        ...
        throw new IllegalStateException("Expected canner block entity at provided BlockPos");
    }
}
