...
public class RecyclerMenu extends MachineWithUpgradesMenu {

    private final RecyclerBlockEntity blockEntity;
    private final Level level;
    private final ContainerData data;

    public RecyclerMenu(final int containerId, final Inventory playerInventory, final FriendlyByteBuf extraData) {
    ...
    public RecyclerMenu(
        ...
        super(MenuTypeRegistry.RECYCLER_MENU.get(), containerId);
        ...
        this.addSlot(new SlotItemHandler(itemHandler, RecyclerBlockEntity.SLOT_INPUT, MachineMenuLayout.SLOT_INPUT_X, MachineMenuLayout.SLOT_INPUT_Y) {
            @Override
            public boolean mayPlace(final ItemStack stack) {
                return RecyclerHelper.canRecycle(stack);
            }
        });
        this.addSlot(new SlotItemHandler(itemHandler, RecyclerBlockEntity.SLOT_OUTPUT, MachineMenuLayout.SLOT_OUTPUT_X, MachineMenuLayout.SLOT_OUTPUT_Y) {
            @Override
            public boolean mayPlace(final ItemStack stack) {
                return false;
            }
    ...
    private static RecyclerBlockEntity getBlockEntity(final Inventory playerInventory, final FriendlyByteBuf extraData) {
        ...
        throw new IllegalStateException("Expected RecyclerBlockEntity at provided BlockPos");
    }
}
