...
/**
 * Expands the adjacent steam reactor grid by one column per attached chamber.
 */
public class SteamChamberBlock extends Block {

    public SteamChamberBlock() {
    ...
    private static void notifyAdjacentReactors(final Level level, final BlockPos pos) {
        ...
        for (net.minecraft.core.Direction direction : net.minecraft.core.Direction.values()) {
            ...
            if (level.getBlockEntity(neighborPos) instanceof SteamReactorBlockEntity reactor) {
